...
export function CategoryCard({ categorySlug, translatedCategoryName, description, iconName }: CategoryCardProps) {
  return (
    <Link 
      ...
      className="block h-full group focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-2xl w-full max-w-[180px] sm:max-w-[200px]" 
      aria-label={`Προβολή κατηγορίας ${translatedCategoryName}`}
    >
      <Card className="flex flex-col items-center justify-center text-center overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-full p-3 relative min-h-[140px] md:min-h-[150px] rounded-2xl bg-card">
        ...
        <div className="transition-opacity duration-300 group-hover:opacity-0 absolute inset-0 flex flex-col items-center justify-center p-3">
          ...
          <CardTitle className="text-sm md:text-base font-bold text-[hsl(217,54%,18%)]">
        ...
        <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 absolute inset-0 flex flex-col items-center justify-center p-3 bg-card/95 backdrop-blur-sm rounded-2xl">
          ...
          <CardTitle className="text-sm md:text-base font-bold text-[hsl(217,54%,18%)] mb-1">
            {translatedCategoryName}
          </CardTitle>
